...
function run($settings)
{
	...
	runScripts($settings, isset($settings->scriptsAfterDeploy) ? $settings->scriptsAfterDeploy : []);
}

function runScripts($settings, $scripts)
{
	foreach ($scripts as $script) $script($settings);
}
